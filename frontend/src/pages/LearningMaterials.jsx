    ...
    <div className="bg-white">
      ...
      <section className="bg-violet-950 py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
              <p className="text-xs font-semibold text-violet-200 tracking-widest mb-4">Resources</p>
      ...
      <section className="py-16 md:py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 text-center shadow-lg">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-4">Portal Login Required</h2>
            ...
            <Link to="/login" className="inline-flex items-center gap-2 px-8 py-4 bg-violet-900 text-white rounded-xl font-bold hover:bg-violet-950 transition-colors">
              Login to Portal
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-3">Available Resources</h2>
