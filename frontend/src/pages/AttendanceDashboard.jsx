...
import {
  ...
  ArrowRight, BookOpen, TrendingUp, ChevronLeft, ChevronRight
} from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {!isToday && (
            <button
              onClick={goToToday}
              className="px-3 py-1.5 rounded-lg bg-violet-100 text-violet-700 text-xs font-semibold hover:bg-violet-200 transition-colors"
            >
              Today
            </button>
          )}
          ...
          <input
            ...
            className="ml-2 px-3 py-1.5 border border-slate-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
          />
        </div>
      </div>
