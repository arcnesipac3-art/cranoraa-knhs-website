  ...
  return (
    <div className="fixed inset-0 z-[9999] flex">
      ...
      <div className="w-full max-w-xl bg-white shadow-2xl flex flex-col h-full overflow-hidden">
        ...
        {/* Quick action bar */}
        <div className="bg-violet-950 px-3 sm:px-4 py-2 flex items-center gap-1.5 sm:gap-2 flex-shrink-0 border-b border-violet-900 overflow-x-auto">
    ...
    <div className="page-bottom-safe bg-slate-50">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 md:gap-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-1 sm:gap-1.5">
          ...
          <div className="flex items-center gap-1 bg-white p-0.5 border border-slate-200 sm:rounded-lg overflow-hidden">
            <button 
      ...
      <div className="bg-white p-2 sm:p-2.5 md:p-3 border border-slate-200">
        <div className="flex flex-col sm:flex-row gap-2 items-center">
          ...
          <select value={gradeFilter} onChange={e => setGradeFilter(e.target.value)}
            className="px-2 sm:px-2.5 py-1.5 bg-slate-50 border border-slate-200 text-xs font-medium focus:outline-none focus:ring-1 focus:ring-violet-500 w-full sm:w-auto">
              ...
              <div className="grid grid-cols-1 gap-2 sm:gap-3 md:gap-4">
                {gradeGroup.classrooms.map((cls) => (
                  <div key={cls.name} className="bg-white border border-slate-200">
                    <div className="px-2 sm:px-3 md:px-4 py-2 sm:py-2.5 bg-slate-50 border-b border-slate-200 flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                      ...
                      <table className="w-full text-left min-w-[320px]">
                        <thead>
                          <tr className="text-[9px] font-bold text-white uppercase tracking-widest bg-[#5e2a84]">
                            ...
                            <th className="px-3 py-2 md:px-4 md:py-2.5 max-w-[140px] sm:max-w-none">Student</th>
