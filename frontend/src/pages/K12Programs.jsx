      ...
      <section className="bg-violet-950 py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
              <p className="text-xs font-semibold text-violet-200 tracking-widest mb-4">DepEd Curriculum</p>
      ...
      <section className="py-16 md:py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-lg mb-12">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">Junior High School</h2>
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-slate-900 mb-3">Learning Areas</h2>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-3">Assessment System</h2>
            ...
            {[
              ...
              <div key={i} className="bg-slate-50 rounded-2xl border border-slate-200 p-6 text-center">
                <div className="text-4xl font-bold text-violet-800 mb-2">{q.weight}</div>
                <h3 className="text-lg font-bold text-slate-900 mb-1">{q.quarter}</h3>
                <p className="text-sm text-gray-600">{q.period}</p>
              </div>
            ))}
          </div>
          <div className="mt-10 bg-violet-900 rounded-2xl p-8 text-white text-center">
            <p className="text-sm font-semibold mb-2">Passing Grade</p>
