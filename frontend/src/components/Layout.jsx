    ...
    staff: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Download App', href: 'https://expo.dev/artifacts/eas/jzXDfGsYZ0jiW1FC0omG1leer4JL6rpa4hDqflIuGx4.apk', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4', external: true },
        ]
      }
    ],
    admin: [
