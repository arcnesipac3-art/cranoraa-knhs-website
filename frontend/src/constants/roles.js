...
export function isAdmin(user) {
  return user?.role === Role.ADMIN || user?.is_admin === true || user?.is_superuser === true;
}
...
export function isAdminOrStaff(user) {
  return user?.role === Role.ADMIN || user?.role === Role.STAFF || user?.is_admin === true || user?.is_superuser === true;
}
