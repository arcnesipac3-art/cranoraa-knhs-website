...
from .models import Announcement, SchoolClass, Department, AcademicYear as PortalAcademicYear, Semester, DatabaseBackup
from accounts.models import AuditLog, AcademicYear
